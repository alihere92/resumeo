        ...
        <Card className="shadow-lg border-0 bg-card/95 backdrop-blur">
          <CardHeader className="text-center">
            ...
            <div className="flex justify-center mb-4">
              <div className="flex items-center justify-center w-12 h-12 bg-gradient-hero rounded-xl">
            ...
            <CardDescription>
              Join thousands of professionals who trust Resumeo to build their perfect resume.
            </CardDescription>
          </CardHeader>
